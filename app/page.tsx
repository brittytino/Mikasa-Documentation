      ...
      <main className="text-center px-4">
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          ...
          <Button asChild size="lg" variant="outline">
            <Link href="https://github.com/mikasa/mikasa-framework" target="_blank" rel="noopener noreferrer">View on GitHub</Link>
          </Button>
        </div>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
          <FeatureCard
            ...
            description="Optimized for speed and efficiency, Mikasa AI delivers rapid results for your AI-powered blockchain applications."
          />
          <FeatureCard
            icon={<Code className="h-10 w-10 text-blue-500" />}
            title="Easy Integration"
            description="Seamlessly integrate Mikasa AI into your existing projects with our comprehensive SDK and clear documentation."
          />
          <FeatureCard
            icon={<Shield className="h-10 w-10 text-green-500" />}
            title="Secure by Design"
            description="Built with security in mind, Mikasa AI ensures your AI models and blockchain data remain protected."
          />
        </div>
      </main>
    </div>
