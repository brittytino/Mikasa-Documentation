    ...
    <footer className="bg-gray-100 dark:bg-gray-800 py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h3 className="text-lg font-semibold mb-4">About Mikasa AI</h3>
            <p className="text-sm text-gray-600 dark:text-gray-300">
              Mikasa AI is a cutting-edge AI framework designed for blockchain and cryptocurrency applications, empowering developers to create intelligent decentralized solutions.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="https://github.com/mikasa" target="_blank" rel="noopener noreferrer" className="text-sm text-blue-500 hover:underline">GitHub</a></li>
              <li><a href="https://discord.gg/mikasa" target="_blank" rel="noopener noreferrer" className="text-sm text-blue-500 hover:underline">Discord</a></li>
              <li><a href="https://twitter.com/mikasa_ai" target="_blank" rel="noopener noreferrer" className="text-sm text-blue-500 hover:underline">Twitter</a></li>
              <li><a href="https://mikasa.blog" target="_blank" rel="noopener noreferrer" className="text-sm text-blue-500 hover:underline">Blog</a></li>
            </ul>
          </div>
          <div>
